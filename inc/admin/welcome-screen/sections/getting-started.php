...
<div id="getting_started" class="islemag-tab-pane active">
	...
	<div class="islemag-tab-pane-half islemag-tab-pane-first-half">
		...
		<p><a href="<?php echo esc_url( 'http://docs.themeisle.com/article/14-how-to-create-a-child-theme/' ); ?>" class="button"><?php esc_html_e( 'View how to do this', 'islemag' ); ?></a></p>
		...
		<p><a href="<?php echo esc_url( 'http://docs.themeisle.com/article/219-how-to-build-a-landing-page-with-a-drag-and-drop-content-builder' ); ?>" class="button"><?php esc_html_e( 'View how to do this', 'islemag' ); ?></a></p>
	...
	<div class="islemag-tab-pane-half">
		...
		<p><a href="<?php echo esc_url( 'http://www.codeinwp.com/blog/top-non-obvious-wordpress-plugins/' ); ?>" class="button"><?php esc_html_e( 'Read more', 'islemag' ); ?></a></p>
	...
	<div class="islemag-tab-pane-half">
		...
		<?php if ( is_plugin_active( 'easy-content-types/easy-content-types.php' ) ) { ?>
			...
			<?php
				...
				<p><a href="<?php echo esc_url( 'http://themeisle.com/plugins/easy-content-types/' ); ?>" class="button button-primary"><?php esc_html_e( 'Download Easy Content Types', 'islemag' ); ?></a></p>
