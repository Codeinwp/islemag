...
function islemag_scripts() {
	...
	wp_enqueue_script( 'islemag-script-all', get_template_directory_uri() . '/js/vendor/script.all.js', array( 'jquery' ), '1.0.1', true );
 ...
 *
 * @global int $comment_open_div Check if comments are open.
 */
