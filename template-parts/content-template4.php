                                  ...
                                  <div class="entry-wrapper">
                                    <article class="entry entry-overlay entry-block eb-small <?php echo $colors[$choosed_color]; ?>">
                                      ...
                                      <div class="entry-meta">
                                        ...
                                        <a href="<?php the_permalink(); ?>" class="entry-comments"><?php comments_number( esc_html__('0 Comments','islemag'), esc_html__('1 Comment','islemag'), esc_html__('% Comments','islemag')  ); ?></a>
                                        <div>
                          ...
                          case 1:
                                  ...
                                  <article class="entry entry-overlay entry-block eb-small <?php echo $colors[$choosed_color]; ?>">
                                    ...
                                    <div class="entry-meta">
                                      <span class="entry-overlay-date"><i class="fa fa-calendar"></i><?php echo get_the_date( 'j M' ); ?></span>
                                      <span class="entry-separator">/</span>
                                      <a href="#" class="entry-comments"><?php comments_number( esc_html__('0 Comments','islemag'), esc_html__('1 Comment','islemag'), esc_html__('% Comments','islemag')  ); ?></a>
                                      <div>
                                        <?php esc_html_e( 'Posted By','islemag' ); ?><a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>" class="entry-author"><?php the_author(); ?></a>
                                      </div>
                                    </div> <!-- End .entry-meta -->
