	...
	if ( is_active_sidebar( 'islemag-sidebar' ) ) {
		...
		the_widget( 'islemag_multiple_ads',
			array(
				...
				'image_uri_ad1' => get_template_directory_uri() . '/img/small_ad_placeholder.png',
				'banner_type1' => 'image',
				'link_ad2' => ( current_user_can( 'edit_theme_options' ) ? admin_url( 'widgets.php' ) : '' ),
				'image_uri_ad2' => get_template_directory_uri() . '/img/small_ad_placeholder.png',
				'banner_type2' => 'image',
				'link_ad3' => ( current_user_can( 'edit_theme_options' ) ? admin_url( 'widgets.php' ) : '' ),
				'image_uri_ad3' => get_template_directory_uri() . '/img/small_ad_placeholder.png',
				'banner_type3' => 'image',
				'link_ad4' => ( current_user_can( 'edit_theme_options' ) ? admin_url( 'widgets.php' ) : '' ),
				'image_uri_ad4' => get_template_directory_uri() . '/img/small_ad_placeholder.png',
				'banner_type4' => 'image',
			),
			array(
